...
| 官方运行态影子迁移 | 优先读取 OpenClaw Tasks、Task audit、Doctor 与 Health，保留 journal fallback，并以 cron contract 指纹保证迁移探针不改任务、排期或投递目标 | `scripts/openclaw/official_runtime_shadow_bridge.py`、`scripts/remote_install_official_runtime_shadow.py`、`config/openclaw/official_runtime_migration.json`、`docs/runtime-notes/openclaw-official-runtime-shadow-migration-2026-07.md` |
