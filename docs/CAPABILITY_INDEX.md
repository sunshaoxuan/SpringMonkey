...
| 聊天与任务总控主模型 | `openai-codex/gpt-5.5` 主力，ccnode `ollama/qwen3:14b` 全局兜底 | `scripts/openclaw/model_fallback_client.py`、`config/news/broadcast.json`、`docs/runtime-notes/openclaw-runtime-baseline-2026-04.md` |
