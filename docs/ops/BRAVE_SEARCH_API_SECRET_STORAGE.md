# Brave Search API Secret Storage

Updated: 2026-04-03 (Asia/Tokyo)

## Purpose

This document records the public storage format for the Brave Search API key used by `OpenClaw`.
...
- Encrypted file:
  - `secrets/brave-search-api.enc.json`
