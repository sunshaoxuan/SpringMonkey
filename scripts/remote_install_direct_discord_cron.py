...
0 7 * * * root /usr/local/lib/openclaw/direct_cron_to_discord.py --name weather-report-jst-0700 --channel-id 1483636573235843072 --timeout 120 --run-as-openclaw --command python3 /var/lib/openclaw/repos/SpringMonkey/scripts/weather/discord_weather_report.py
