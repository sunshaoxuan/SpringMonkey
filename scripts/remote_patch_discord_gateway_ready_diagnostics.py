...
journalctl -u openclaw.service --since '2 minutes ago' --no-pager | egrep -i 'discord gateway diag|awaiting gateway readiness|logged in to discord|gateway was not ready|gateway error|gateway closed|client initialized' | tail -120
echo DONE
"""
