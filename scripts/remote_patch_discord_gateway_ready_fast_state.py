...
journalctl -u openclaw.service --since '2 minutes ago' --no-pager | egrep -i 'discord gateway READY confirmed|springmonkey fast READY|logged in to discord|awaiting gateway readiness|did not reach READY|gateway was not ready|liveness warning' | tail -140
echo DONE
"""
