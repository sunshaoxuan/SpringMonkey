...
journalctl -u openclaw.service --since '2 minutes ago' --no-pager | egrep -i 'discord gateway READY confirmed|logged in to discord|awaiting gateway readiness|discord gateway trace|discord gateway diag|did not reach READY|gateway was not ready|liveness warning' | tail -120
echo DONE
"""
