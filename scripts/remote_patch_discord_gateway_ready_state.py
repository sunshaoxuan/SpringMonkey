...
journalctl -u openclaw.service --since '2 minutes ago' --no-pager | egrep -i 'springmonkey gateway ready state|discord gateway diag|logged in to discord|awaiting gateway readiness|gateway was not ready|did not reach READY|client initialized|liveness warning' | tail -160
echo DONE
"""
