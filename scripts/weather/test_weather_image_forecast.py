...
def fake_fetch_json(url: str) -> dict:
    ...
    return {
        "current": {"temperature_2m": 22, "weather_code": 2, "precipitation": 0, "wind_speed_10m": 12, "uv_index": 4},
        "daily": {"weather_code": [2], "temperature_2m_max": [27], "temperature_2m_min": [17], "precipitation_probability_max": [30]},
    }
